...
登録する過程で自分と対話し、**判断軸**を見つける旅に出ましょう！  
...
以上の経験を踏まえ、**物に対する判断軸を見つけ、残したお気に入りのモノを共有するサービス**があれば上記の課題を解決できるのではないかと思い、本アプリを制作しました。
...
* 人によって登録制限をオーバーしてしまう可能性があるため、制限付きで**増枠**できるようにしました。（max10枠まで）
